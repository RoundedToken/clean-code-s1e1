...
var createNewTaskElement=function(taskString){
    ...
    label.className='task task_not-editable';

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.className='tasks-list__item__checkbox'
    editInput.type="text";
    editInput.className="task task_editable";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="button_edit button_default";

    deleteButton.className="button_delete button_default";
